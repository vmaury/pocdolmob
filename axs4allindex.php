...
/**
 *	\file       axs4all/axs4allindex.php
 *	\ingroup    axs4all
 *	\brief      Home page of axs4all top menu
 */
...
// Security check
// if (! $user->rights->axs4all->myobject->read) {
// 	accessforbidden();
// }
...
// Draft MyObject
if (! empty($conf->axs4all->enabled) && $user->rights->axs4all->read)
{
	$langs->load("orders");
...
if (! empty($conf->axs4all->enabled) && $user->rights->axs4all->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."axs4all_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
