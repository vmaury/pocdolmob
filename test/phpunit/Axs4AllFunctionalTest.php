...
/**
 * \file    test/phpunit/Axs4AllFunctionalTest.php
 * \ingroup axs4all
 ...
 * @package Testaxs4all
 */
class Axs4AllFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/axs4all/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('axs4all/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/axs4all/admin/about.php');
		$this->authenticate();
		return $this->assertContains('axs4all/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('axs4allwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAxs4All_Axs4AllTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAxs4All_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
